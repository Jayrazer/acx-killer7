...
SWEP.PrintName = "Beretta Cougar"
SWEP.Category = "ACXION - Killer7"

-- Infobox
SWEP.Description = "Compact pistol used by Jean DePaul."
SWEP.TypeName = "Pistol"

SWEP.Model = "models/killer7/weapons/killer7_pistol_beretta_cougar.mdl"
SWEP.WorldModel = SWEP.Model

SWEP.ModelOffsetView = Vector(5, 12, -5.5)
