...
SWEP.PrintName = "Enfield No. 2 \"FREAK SCENE\""
SWEP.Category = "ACXION - Killer7"

-- Infobox
SWEP.Description = "Customized revolver used by Coyote Smith. Named after the song by Dinosaur Jr."
SWEP.TypeName = "Revolver"

SWEP.Model = "models/killer7/weapons/killer7_revolver_enfield_freak_scene.mdl"
...
SWEP.ShootSound = "weapons/k7/freakscene_fire.wav"
SWEP.ShootVolume = 110

SWEP.DryFireSound = "weapons/ar2/ar2_empty.wav"

SWEP.ReloadStartSound = "weapons/k7/freakscene_clipout.wav"
SWEP.ReloadFinishSound = "weapons/k7/freakscene_clipin.wav"