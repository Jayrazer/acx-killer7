...
SWEP.PrintName = "Colt Python" -- I'm not gonna sugarcoat it... Spacebar, Q, Q, Q, left click...
SWEP.Category = "ACXION - Killer7"

-- Infobox
SWEP.Description = "Sleek revolver used by Benjamin Keane"
SWEP.TypeName = "Revolver"

SWEP.Model = "models/killer7/weapons/killer7_revolver_colt_python.mdl"
