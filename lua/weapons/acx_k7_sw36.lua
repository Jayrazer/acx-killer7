...
SWEP.PrintName = "S&W Model 36" -- I'm not gonna sugarcoat it... Spacebar, Q, Q, Q, left click...
SWEP.Category = "ACXION - Killer7"

-- Infobox
SWEP.Description = "Snubnose revolver."
SWEP.TypeName = "Revolver"

SWEP.Model = "models/killer7/weapons/killer7_revolver_smith_and_wesson_model_36.mdl"
