...
SWEP.PrintName = "S&W Model 629" -- I'm not gonna sugarcoat it... Spacebar, Q, Q, Q, left click...
SWEP.Category = "ACXION - Killer7"

-- Infobox
SWEP.Description = "Big magnum revolver."
SWEP.TypeName = "Revolver"

SWEP.Model = "models/killer7/weapons/killer7_revolver_smith_and_wesson_model_629.mdl"
